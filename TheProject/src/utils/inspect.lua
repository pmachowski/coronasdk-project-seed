...
function Inspector:new(t, depth, smt)
  local inspector = {
    smt = smt,
    buffer = {},
    depth = depth,
...
setmetatable(inspect, { __call = function(_,t,depth,mt)
  return Inspector:new(t, depth, mt):tostring()
end })
